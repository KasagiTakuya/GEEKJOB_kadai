...
public class InsertConfirm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            udata.setyear(request.getParameter("year"));
            udata.setmonth(request.getParameter("month"));
            udata.setday(request.getParameter("day"));
            udata.settype(request.getParameter("type"));
            udata.settell(request.getParameter("tell"));
            udata.setcomment(request.getParameter("comment"));
