...
<html>
    ...
    <form action="insertconfirm" method="POST">
        ...
        生年月日:　
        <select name="year">
            <option value="<%if(hs.getAttribute("month")!=null){out.print(hs.getAttribute("year"));}%>"><%if(hs.getAttribute("year")!=null){out.print(hs.getAttribute("year"));}else out.println("----");%></option>
            <%
        ...
        <select name="month">
            <option value="<%if(hs.getAttribute("month")!=null){out.print(hs.getAttribute("month"));}%>"><%if(hs.getAttribute("month")!=null){out.print(hs.getAttribute("month"));}else out.println("--");%></option>
            <%
            for(int i = 1; i<=12; i++){ %>
            <option value="<%=i%>"><%=i%></option>
            <% } %>
        ...
        <select name="day">
            <option value="<%if(hs.getAttribute("day")!=null){out.print(hs.getAttribute("day"));}%>"><%if(hs.getAttribute("day")!=null){out.print(hs.getAttribute("day"));}else out.println("--");%></option>
            <%
            for(int i = 1; i<=31; i++){ %>
            <option value="<%=i%>"><%=i%></option>
            <% } %>
