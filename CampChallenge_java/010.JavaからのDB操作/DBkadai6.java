 ...
 * @author PCUser
 */
@WebServlet(name = "DBkadai6", urlPatterns = {"/DBkadai6"})
public class DBkadai6 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
           ...
           db_st = db_con.prepareStatement("delete  from profiles where profilesID like ?");
